...
class CommonPodcastCommentTableViewCell : UITableViewCell {
...
//
//        if let chat = chat, let podcast = chat.podcast, podcastPlayerController.isPlaying(podcastId: podcast.feedID) {
